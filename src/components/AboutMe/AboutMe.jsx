  ...
  return (
    <section className='aboutMe' id='aboutMe'>
      ...
      <div className='aboutMe__cards'>
        <img src='https://aigis.club/uploads/posts/2022-05/1653296256_29-adonius-club-p-sindzi-na-stule-oboi-krasivo-48.png' alt='Фото студента' className='aboutMe__photo' />
        <div className='aboutMe__texts'>
          ...
          <a href='https://github.com/ratioglobus' className='aboutMe__link links-hover-state'>Github</a>
        </div>
      </div>
    </section>
  )
